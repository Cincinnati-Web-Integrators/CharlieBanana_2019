(function($, document, window, undefined) {
  window.IPRedirect = {
    init: function(settings) {
      ...
      self.messageWrap = $("#location-redirect-message,#location-redirect-popup");
    ...
    fetchAndShowRedirect: function( location ) {
      ...
      if ( self.urlMap[location.country_code].url != null ) {
        ...
        if (self.relativeRedirect) {
          self.RedirectMe.attr("href", self.urlMap[location.country_code].url + window.location.pathname);
        } else {
    ...
    fetchAndRedirectOnResponse: function( location ) {
      ...
      if(self.urlMap[location.country_code].url != null) {
        if (self.relativeRedirect) {
          window.location.assign(self.urlMap[location.country_code].url + window.location.pathname);
        } else {
